...
class SystemConfigValidata extends Validate
{
    ...
    protected $message = [
        ...
        'site_phone.number' => '联系电话必须为整数',
        'site_phone.mobile' => '联系电话请填写有效的手机号',
        'contact_number.number' => '联系电话必须为整数',
        'contact_number.mobile' => '联系电话请填写有效的手机号',
		...
		'register_give_money.number' => '用户注册赠送余额数量必须为整数',
