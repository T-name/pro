...
class StoreOrderController
{
    ...
    public function data(Request $request)
    {
        ...
        return app('json')->successful($this->services->getOrderDataPriceCount(['time' => [$start, $stop], 'plat_type' => 0]));
    }
    ...
    public function time(Request $request)
    {
        ...
        $order_where = ['pid' => 0, 'paid' => 1, 'refund_status' => [0, 3], 'store_id' => 0, 'is_del' => 0, 'is_system_del' => 0, 'plat_type' => 0];
        if ($type == 1) {//销售额
