...
class UserAddressServices extends BaseServices
{
    ...
    {
        return CacheService::redisHandler('userAdder')->remember('user_adderss_cache_' . $id, function () use ($id) {
    ...
    {
        return CacheService::redisHandler('userAdder')->remember('user_adderss_cache_user_' . $uid, function () use ($uid) {
