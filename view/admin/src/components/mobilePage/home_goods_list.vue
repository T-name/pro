                        ...
                        <div class="item" :class="conStyle?'':'itemOn'" v-for="(item,index) in list" :index="index">
                            ...
                            <div class="info">
                                ...
                                <div class="price" :style="{color:fontColor}">
                                    ...
                                    <div class="label" :style="'border:1px solid '+labelColor+';color:'+labelColor" :class="priceShow?'':'on'" v-if="item.couponId && item.couponId.length && couponShow">券</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <template v-if="itemStyle == 3">
                    <div class="listBig" v-if="list.length>0">
                        <div class="itemBig" :class="conStyle?'':'itemOn'" v-for="(item,index) in list" :key="index">
                            ...
                            <div class="name line2"><span class="coupon" :style="'border:1px solid '+labelColor+';color:'+labelColor" v-if="item.couponId && item.couponId.length && couponShow">券</span><span  v-if="titleShow">{{item.store_name}}</span></div>
