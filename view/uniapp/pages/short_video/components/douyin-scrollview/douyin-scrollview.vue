<template>
	<view>
					...
					<view
						...
						<view style="display: flex; flex-direction: row;">
							...
							<view v-if="list.uid == 0"
								...
								<text
									style="font-size: 8px; font-weight: bold; padding: 2.5px; padding-left: 4px; padding-right: 4px; font-weight: bold; color: #FFFFFF;">商家</text>
							</view>
						</view>
						<!-- 5. 
						...
						<view
							...
							<text style="font-size: 12px; color: #a3a1a4;">{{list.add_time}} .
								{{list.city?list.city:''}}</text>
							...
							<view :style="'width: '+ (Width*0.8) +'px; display: flex; flex-direction: row;'">
								...
								<view
									...
									<view style="display: flex; flex-direction: row;">
										<view style="display: flex; flex-direction: row;">
											...
											<view v-if="li.uid==0"
												style="background-color: #E43D33; border-radius: 2.5px; margin-left: 7.5px;">
												<text
													style="font-size: 8px; font-weight: 400; padding: 1px 4px; color: #fff;">商家</text>
											</view>
										</view>
									</view>
									<!-- 16.
									...
									<view
										...
										<text style="font-size: 12px; color: #a3a1a4;">{{li.add_time}} .
											{{li.city?li.city:''}}</text>
		...
		<!-- 21.底部，模拟假的输入框 -->
		<view v-if="show" @click="parentPinglun" :style="'width: '+ Width +'px; height: 46px; background-color: #fff;'">
			<view
		...
		<uni-popup type="bottom" ref="openPinglun" @touchmove.stop.prevent="movehandle" @change="change">
			<view style="display: flex; flex-direction: column;">
				<view @click="openPinglun"
					...
					<view
						:style="'width: '+ (Width-30)*percent +'px; margin-left: 15px; margin-top: 10px; background-color: #eee; border-radius: '+ borderRadius +'px; margin-bottom: 10px; display: flex; flex-direction: row;'">
						<!-- 
						9.输入框 
						 -->
						<textarea
							:style="'width:100%; height: 20px; margin-bottom: 10px; font-size: 15px; color: #000000; margin-top: 10px; margin-left: 15px;'"
