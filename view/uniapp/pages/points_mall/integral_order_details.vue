<template>
	<view :style="colorStyle">
		<view class='order-details'>
			<view v-if="cartInfo.product_type == 0">
				<view class='address'>
			...
			<view class="orderGoods" :class="cartInfo.product_type == 0?'':'on'">
			...
			<view v-if="cartInfo.status!=0">
				<view class='wrapper' v-if='cartInfo.delivery_type=="fictitious" && cartInfo.product_type!=1'>
				...
				<view class='wrapper' v-if="cartInfo.virtual_info && cartInfo.product_type==1">
					<view class='item acea-row row-between'>
						<view>卡密发货：</view>
						<view class='conter'>{{cartInfo.virtual_info}}</view>
					</view>
				</view>
			</view>
			<customForm :customForm="cartInfo.custom_form"></customForm>
			<view class='wrapper'>
				<view class='item acea-row row-between'>
					<view>订单编号：</view>
			...
			<view class='footer acea-row row-right row-middle' v-if="cartInfo.status>1">
