<template>
	<view :style="colorStyle">
		...
		<product-window :attr='attribute' :limitNum='1' :cusPreviewImg='1' :type="'points'" @myevent="onMyEvent" @ChangeAttr="ChangeAttr"
			@ChangeCartNum="ChangeCartNum" @attrVal="attrVal" @iptCartNum="iptCartNum" @getImg="showImg" id="product-window"></product-window>
		...
		methods: {
			...
			changeSwitch(e){
				...
				if (productSelect) {
					...
					this.$set(this.attribute.productSelect, 'vip_price', productSelect.vip_price);
			...
			iptCartNum: function(e) {
				let num = parseInt(this.attribute.productSelect.quota)>=parseInt(e)?parseInt(e):parseInt(this.attribute.productSelect.quota);
