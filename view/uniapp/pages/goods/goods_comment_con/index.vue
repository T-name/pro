		...
		<form @submit="formSubmit" report-submit='true'>
			<view class='evaluate-con'>
				...
				<view class='score'>
					...
					<view class='textarea'>
						<textarea placeholder='商品满足你的期待么？说说你的想法，分享给想买的他们吧~(最多输入100个字)' name="comment"
							placeholder-class='placeholder' maxlength='100'></textarea>
						<view class='list acea-row row-middle'>
							<view class='pictrue' v-for="(item,index) in pics" :key="index" v-if="index<8">
